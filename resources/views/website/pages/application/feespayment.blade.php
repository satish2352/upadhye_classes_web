                                ...
                                <div class="col-xl-6">
                                    <div class="checkout-page__input-box">
                                        <input type="text" name="remark" value=""
                                            placeholder="Please Enter Remark" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="checkout-page__check-box">
                                        ...
                                        <label for="skipper4">I Agree to receive SMS/Call from Upadhye Classes
                                            I have read all Privacy Policy and Refund Policy, Agree to receive SMS/Call from Upadhye Classes<span></span></label>
                                    </div>
                                </div>
                            </div>
                        </form>
