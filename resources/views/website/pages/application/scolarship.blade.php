            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="checkout-page__billing-address">
                        ...
                        <form class="forms-sample" action="{{ url('add-scolarship') }}" id="regForm" method="POST"
                        enctype="multipart/form-data">
                        @csrf    
                        <div class="row bs-gutter-x-20">
                                <div class="col-xl-6 py-2">
                                    <div class="checkout-page__input-box">
                                        <select class="form-control" aria-label="Default select example"  name="edu_course" id="edu_course">
                                ...
                                <div class="col-xl-6 py-2">
                                    <div class="checkout-page__input-box">
                                        <select class="form-control" aria-label="Default select example"  name="edu_mode" id="edu_mode">
                                ...
                                <div class="col-xl-6 py-2">
                                    <div class="">
                                        <input type="text" name="address" id="address"
                                            value="{{ old('address') }}" placeholder="Please Enter Address" class="form-control">
                                ...
                                <div class="col-xl-6 py-2">
                                    <div class="">
                                        <input type="text" name="roll_number" id="roll_number" value="{{ old('role_number') }}"
                                            placeholder="Please Enter Roll Number"  class="form-control">
                                            @if ($errors->has('roll_number'))
                                            <span class="red-text">{{ $errors->first('roll_number') }}</span>
                                        @endif
                                    </div>
                                </div>
