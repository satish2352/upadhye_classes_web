...
"margin": 0
        ...
        <div class="item"><!-- slider-item-start -->
            <div class="main-slider__item">
                <div class="main-slider__bg" style="background-image: url({{ asset('website/assets/images/shapes/slider-bg-1.jpg')}});"></div><!-- slider-image-->
                <div class="main-slider__shape-one"><img src="{{ asset('website/assets/images/shapes/slider-shape-1.png')}}" alt="eduact" /></div><!-- slider-shape-1 -->
                <div class="main-slider__shape-two"><img src="{{ asset('website/assets/images/shapes/slider-shape-2.png')}}" alt="eduact" /></div><!-- slider-shape-2 -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="main-slider__content">
                                <h2 class="main-slider__title">AIR 1167 <br> <span>Congratulations !</span></h2><!-- slider-title -->
                                <!-- slider-text -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="main-slider__shape-six">
                                <img src="{{ asset('website/assets/images/shapes/slider-shape-6.png')}}" alt="eduact" />
                            </div><!-- slider-shape-6 -->
                            <div class="main-slider__shape-seven">
                                <img src="{{ asset('website/assets/images/shapes/slider-shape-7.png')}}" alt="eduact" />
                            </div><!-- slider-shape-6 -->
                            <div class="main-slider__shape-eight">
                                <span class="icon-business"></span>
                            </div><!-- slider-shape-6 -->
                            <div class="main-slider__shape-nine">
                                <img src="{{ asset('website/assets/images/shapes/slider-shape-9.png')}}" alt="eduact" />
                            </div><!-- slider-shape-6 -->
                        </div>
                    </div>
                </div>
            ...
            <div class="main-slider__item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="main-slider__content">
                                <h2 class="main-slider__title">AIR 1684 <br> <span>Congratulations !</span></h2><!-- slider-title -->
                                <!-- slider-text -->
                                {{-- <div class="main-slider__btn">
                                    <a href="course.html" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span>Find the Course<i class="icon-arrow"></i></a><!-- /.btn -->
                                </div> --}}
            ...
            <div class="main-slider__item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="main-slider__content">
                                <h2 class="main-slider__title">AIR 1326 <br> <span>Congratulations !</span></h2><!-- slider-title -->
                                <!-- slider-text -->
                                {{-- <div class="main-slider__btn">
                                    <a href="course.html" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span>Find the Course<i class="icon-arrow"></i></a><!-- /.btn -->
                                </div> --}}
...
<!-- About End -->
<!-- Service Start -->
<section class="service-two" style="background-image: url({{ asset('website/assets/images/shapes/service-bg-2.jpg')}});">
    <div class="container">
            ...
            <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div class="service-two__item text-center">
                    <div class="service-two__wrapper">
                        ...
                        <p class="service-two__text">The Joint Entrance Examination, JEE (Main) comprises two papers. Paper 1 is conducted for</p><!-- /.service-content -->
                        <a class="service-two__rm" href="team.html">Read More<span class="icon-caret-right"></span></a>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                <div class="service-two__item text-center">
                    <div class="service-two__wrapper">
                        ...
                        <p class="service-two__text">NATIONAL ELIGIBILITY CUM ENTRANCE TEST [ NEET (UG)] will be conducted</p><!-- /.service-content -->
                        <a class="service-two__rm" href="team-become.html">Read More<span class="icon-caret-right"></span></a>
                    </div>
                </div><!-- /.service-card-one -->
            </div>
            <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="service-two__item text-center">
                    <div class="service-two__wrapper">
                        ...
                        <p class="service-two__text">NATIONAL ELIGIBILITY CUM ENTRANCE TEST [ NEET (UG)] will be conducted</p><!-- /.service-content -->
                        <a class="service-two__rm" href="course.html">Read More<span class="icon-caret-right"></span></a>
                    </div>
                </div><!-- /.service-card-one -->
            </div>
            <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                <div class="service-two__item text-center">
                    <div class="service-two__wrapper">
                        ...
                        <p class="service-two__text">NATIONAL ELIGIBILITY CUM ENTRANCE TEST [ NEET (UG)] will be conducted by National</p><!-- /.service-content -->
                        <a class="service-two__rm" href="about.html">Read More<span class="icon-caret-right"></span></a>
                    </div>
                </div><!-- /.service-card-one -->
            </div>
        </div>
   ...
   <section class="testimonial-three">
    <div class="container">
        ...
        "dots":false
                ...
                <a href="#item1" class="item" data-hash="item1"><img src="assets/images/resources/testimonial-3-1.jpg" alt="eduact"></a><!-- Testimonial Item -->
                <a href="#item2" class="item" data-hash="item2"><img src="assets/images/resources/testimonial-3-2.jpg" alt="eduact"></a><!-- Testimonial Item -->
                <a href="#item3" class="item" data-hash="item3"><img src="assets/images/resources/testimonial-3-3.jpg" alt="eduact"></a><!-- Testimonial Item -->
            </div>
            <!-- Testimonial Thumb -->
            <div class="testimonial-three__carousel eduact-owl__carousel owl-theme owl-carousel" data-owl-options='{
        "items": 1,
        "margin": 0,
        "smartSpeed": 700,
        "loop":true,
        ...
        "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow\"></span>"]
                ...
                <div class="item" data-hash="item1">
                    <div class="testimonial-three__item">
                        <div class="testimonial-three__author">
                            <img src="assets/images/resources/testimonial-3-1.jpg" alt="eduact">
                        </div><!-- testimonial-author -->
                        <div class="testimonial-three__content">
                            <div class="testimonial-three__quote">
                                Flexible Classes refers to the process of acquiring knowledge or skills through the use
                                of digital technologies and the internet. Flexible Classes refers to the process
                                flexible Classes refers to the process Flexible Classes refers to the process
                                of acquiring knowledge or skills
                            </div><!-- testimonial-quote -->
                            <p class="testimonial-three__average-ratings">4.7 Average Rating</p>
                            <div class="testimonial-three__ratings">
                            ...
                            <div class="testimonial-three__meta">
                                <h5 class="testimonial-three__title">Savannah Nguyen</h5>
                                <span class="testimonial-three__designation">UI/UX Designer</span>
                ...
                <div class="item" data-hash="item2">
                    <div class="testimonial-three__item">
                        <div class="testimonial-three__author">
                            <img src="assets/images/resources/testimonial-3-2.jpg" alt="eduact">
                        </div><!-- testimonial-author -->
                        <div class="testimonial-three__content">
                            <div class="testimonial-three__quote">
                                Flexible Classes refers to the process of acquiring knowledge or skills through the use
                            ...
                            <div class="testimonial-three__meta">
                                <h5 class="testimonial-three__title">Sarah Taylor</h5>
                                <span class="testimonial-three__designation">Seo Expert</span>
                            </div><!-- testimonial-meta -->
                        </div>
                    </div>
                </div>
                ...
                <div class="item" data-hash="item3">
                    <div class="testimonial-three__item">
                        <div class="testimonial-three__author">
                            <img src="assets/images/resources/testimonial-3-3.jpg" alt="eduact">
                        </div><!-- testimonial-author -->
                        <div class="testimonial-three__content">
                            <div class="testimonial-three__quote">
                                Flexible Classes refers to the process of acquiring knowledge or skills through the use
                            ...
                            <div class="testimonial-three__meta">
                                <h5 class="testimonial-three__title">Christine Eve</h5>
                                <span class="testimonial-three__designation">Web Developer</span>
                            </div><!-- testimonial-meta -->
                        </div>
                    </div>
                </div>
        ...
        "1200":{
            ...
            <div class="item">
                <div class="category-two__item">
                    ...
                    <h3 class="category-two__title"><a href="about.html">MHT-CET Test Series Start from  28th September, 2023</a></h3><!-- /.category-title -->
            ...
            <div class="item">
                <div class="category-two__item">
                    ...
                    <h3 class="category-two__title"><a href="about.html">NEET Test Series Start from 30th September, 2023</a></h3><!-- /.category-title -->
                </div><!-- /.category-card-one -->
            </div>
            <div class="item">
                <div class="category-two__item">
                    ...
                    <h3 class="category-two__title"><a href="about.html">JEE Mains Test Series Start from 16st September, 2023</a></h3><!-- /.category-title -->
                </div><!-- /.category-card-one -->
            </div>
            <div class="item">
                <div class="category-two__item">
                    ...
                    <h3 class="category-two__title"><a href="about.html">Revision Batch starts from 15th Nov 2023</a></h3><!-- /.category-title -->
                </div><!-- /.category-card-one -->
            </div>
        </div>
    </div>
...
<section class="video-one">
    <div class="container">
        <div class="video-one__bg" style="background-image: url({{ asset('website/assets/images/backgrounds/video-bg-1.jpg')}});">
            <div class="video-one__shape" style="background-image: url({{ asset('website/assets/images/shapes/video-shape-1.png')}});"></div>
            <div class="video-one__shape2" style="background-image: url({{ asset('website/assets/images/shapes/video-shape-2.png')}});"></div>
            <div class="row">
                <div class="col-lg-6 col-md-7 wow fadeInLeft" data-wow-delay="200ms">
                    ...
                    <a href="contact.html" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span>Discover More<i class="icon-arrow"></i></a>
                </div>
                <div class="col-lg-6 col-md-5 wow fadeInRight" data-wow-delay="200ms">
                    <div class="video-one__btn">
                        <img src="{{ asset('website/assets/images/backgrounds/video-btn-bg-1.png')}}" alt="eduact" />
                ...
                <div class="blog-two__item">
                    ...
                    <div class="blog-two__content">
                        ...
                        <span class="service-two__text mb-3">
                            Upadhye Classes's faculty team has a vast experience of teaching Lakhs of students who prepared for JEE-Advanced, JEE-Main, KVPY, NTSE etc.
                        </span>
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div class="blog-two__item">
                    ...
                    <div class="blog-two__content">
                        ...
                        <span class="service-two__text mb-3">
                            Students performance analysis is done through their performance in the periodic tests. Students are motivated to perform well in the upcoming tests.
                        </span>
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                <div class="blog-two__item">
                    ...
                    <div class="blog-two__content">
                        ...
                        <span class="service-two__text mb-3">
                            Course planning is prepared well in advance for each & every course. The course Planner prepared from this planning is provided to students after joining the courses.
                        </span>
                        {{-- <div class="blog-two__meta">
                            <div class="blog-two__meta__author">
                                <img src="{{ asset('website/assets/images/blog/author-1.png')}}" alt="eduact" />
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="blog-two__item">
                    ...
                    <div class="blog-two__content">
                        ...
                        <span class="service-two__text mb-3">
                            Periodic tests are organized to check the preparation of the student & provide it much needed impetus. The tests are conducted on Part Syllabus, Cumulative Syllabus & Full Syllabus basis.
                        </span>
                        {{-- <div class="blog-two__meta">
                            <div class="blog-two__meta__author">
                                <img src="{{ asset('website/assets/images/blog/author-1.png')}}" alt="eduact" />
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                <div class="blog-two__item">
                    ...
                    <div class="blog-two__content">
                        ...
                        <span class="service-two__text mb-3">
                            Study Material is provided in terms of Sheets, Daily Practice Problems (DPPs) etc. Topics wise Sheets has the theory content about the topic followed by solved, unsolved examples.
                        </span>
                        {{-- <div class="blog-two__meta">
                            <div class="blog-two__meta__author">
                                <img src="{{ asset('website/assets/images/blog/author-1.png')}}" alt="eduact" />
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                <div class="blog-two__item">
                    ...
                    <div class="blog-two__content">
                        ...
                        <span class="service-two__text mb-3">
                            Regular Classes are conducted as per Time Table which is provided to the students in advance. Students need to take maximum benefit/learning from the regular classes.
                        </span>
                        {{-- <div class="blog-two__meta">
                            <div class="blog-two__meta__author">
                                <img src="{{ asset('website/assets/images/blog/author-1.png')}}" alt="eduact" />
...
<!-- Testimonial Start -->
<section class="testimonial-two" style="background-image: url({{ asset('website/assets/images/shapes/testimonial-bg-2.png')}});">
    <div class="container">
        <div class="section-title text-center">
            <h5 class="section-title__tagline">
                Testimonial
        ...
        "1200":{
            ...
            <div class="item">
                <div class="testimonial-two__item">
                    <div class="testimonial-two__item-inner" style="background-image: url({{ asset('website/assets/images/shapes/testimonial-shape-2.png')}});">
                        ...
                        <div class="testimonial-two__meta">
                            <img src="{{ asset('website/assets/images/resources/testimonial-2-author-1.png')}}" alt="eduact">
            ...
            <div class="item">
                <div class="testimonial-two__item">
                    <div class="testimonial-two__item-inner" style="background-image: url({{ asset('website/assets/images/shapes/testimonial-shape-2.png')}});">
                        ...
                        <div class="testimonial-two__meta">
                            <img src="{{ asset('website/assets/images/resources/testimonial-2-author-2.png')}}" alt="eduact">
            ...
            <div class="item">
                <div class="testimonial-two__item">
                    <div class="testimonial-two__item-inner" style="background-image: url({{ asset('website/assets/images/shapes/testimonial-shape-2.png')}});">
                        ...
                        <div class="testimonial-two__meta">
                            <img src="{{ asset('website/assets/images/resources/testimonial-2-author-3.png')}}" alt="eduact">
