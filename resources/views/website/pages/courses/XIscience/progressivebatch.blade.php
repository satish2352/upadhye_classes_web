...
@section('content')
    ...
    <section class="page-header page-header--bg-two" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
        ...
        <div class="container text-center">
            <h2 class="page-header__title">Progressive Batch</h2><!-- /.page-title -->
            <ul class="page-header__breadcrumb list-unstyled">
                <li><a href="index-2.html">Home</a></li>
                <li><span>Regular Batch</span></li>
            </ul><!-- /.page-breadcrumb list-unstyled -->
        </div><!-- /.container -->
    </section><!-- /.page-header -->
    <!-- Course Start -->
    <section class="course-three"
        style="background-image: url({{ asset('website/assets/images/shapes/course-bg-1.png') }});" id="course">
        <div class="container">
                    ...
                    <div class="course-three__item">
                        <div class="course-three__content p-3">
                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-lg-9"><span class="course-details__overview__text"> Monday to Sunday 5 to 7 hours of studying.</span></div>
                            </div>
                            <hr>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-9"><span class="course-details__overview__text">Student can option for 1 or 2 year course.</span></div>
                            </div>
                            <hr>
                            <div class="row ">
                                <div class="col-lg-3 d-flex align-items-center">
