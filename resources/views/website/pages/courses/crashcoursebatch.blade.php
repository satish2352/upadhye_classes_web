...
@section('content')
    ...
    <!-- Course Start -->
    <section class="course-three" style="background-image: url(assets/images/shapes/course-bg-3.png);" id="course">
        <div class="container">
                    ...
                    <div class="course-three__item">
                        <div class="course-three__content">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <h3 class="testimonial-two__title"><span class="icon-color-yekkow"><i
                                                class="icon-history"></i></span> Course Type :</h3>
                                </div>
                                <div class="col-lg-9"><p class="course-details__overview__text"> Monday to Sunday 6 to 9 hours of studying.</p></div>
                            </div>
                            <hr>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-9"> This Batch is conducted from March to till May for 2 Months .</div>
                            </div>
                            <hr>
                            <div class="row ">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9"> Must have passed 10+2 or equivalent with Physics, Chemistry, Biology,
                                    Math and English as core subjects from a recognized board.</div>
                            </div>
                            <hr>
                            <div class="row ">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9"> Class 12 or equivalent appearing aspirants are also eligible to apply
                                    for NEET.</div>
                            </div>
                            <hr>
                        </div><!-- /.course-content -->
