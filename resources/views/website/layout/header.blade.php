...
<!-- Mirrored from bracketweb.com/eduact-html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Dec 2023 09:38:16 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Upadhye Classes</title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('website/assets/images/favicons/apple-touch-icon.png')}}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('website/assets/images/favicons/favicon-32x32.png')}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('website/assets/images/favicons/favicon-16x16.png')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('website/assets/vendors/eduact-icons/style.css')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('website/assets/vendors/owl-carousel/assets/owl.carousel.min.css')}}" />
    <link rel="stylesheet" href="{{ asset('website/assets/vendors/owl-carousel/assets/owl.theme.default.min.css')}}" />
