...
@section('content')
    ...
    <div class="main-panel">
        ...
        <form method="POST" action="{{ url('/delete-ourresult-category') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-ourresult-category') }}" id="showform">
            @csrf
            <input type="hidden" name="show_id" id="show_id" value="">
        </form>
        <form method="POST" action="{{ url('/update-one-ourresult-category') }}" id="activeform">
            @csrf
