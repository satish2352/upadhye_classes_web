...
@section('content')
    <div class="main-panel">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($gallery as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                    <a href="{{ route('edit-ourresult', base64_encode($item->id)) }}"
        ...
        <form method="POST" action="{{ url('/delete-ourresult') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-ourresult') }}" id="showform">
            @csrf
            <input type="hidden" name="show_id" id="show_id" value="">
        </form>
        <form method="POST" action="{{ url('/update-one-ourresult') }}" id="activeform">
            @csrf
