...
<nav class="sidebar sidebar-offcanvas fixed-nav" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item ">
          ...
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#cources" aria-expanded="false" aria-controls="master">
                <i class="fa fa-th-large menu-icon"></i>
            ...
            <div class="collapse" id="cources">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item d-none d-lg-block"><a class="nav-link active"
                            href="{{ route('list-main-menu') }}">Main manu</a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('list-sub-menu') }}">Sub Menu</a></li>
                    
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('list-dynamic-page') }}">Menu Content</a>
